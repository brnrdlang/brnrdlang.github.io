...
export class ShaderProgram {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_shaderprogram_free(ptr);
    }
    /**
    * @param {WebGlCanvas} canvas
    */
    constructor(canvas) {
        _assertClass(canvas, WebGlCanvas);
        wasm.shaderprogram_new(canvas.ptr);
    }
    /**
    * @param {WebGlCanvas} canvas
    * @param {number} time
    */
    render(canvas, time) {
        _assertClass(canvas, WebGlCanvas);
        wasm.shaderprogram_render(this.ptr, canvas.ptr, time);
    }
}
/**
*/
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('gestalt_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_settype_12c0b72d28adc72b = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_start_83f83becc89cfaaa = function() { return handleError(function (arg0) {
